            ...
            if i in perm:
                for c in range(channels):
                    if idx==args.attacker_list[0]:
                        ...
                        img[c, 1, 0] = pixel_value
                        img[c, 1, 1] = pixel_value
                    elif idx==args.attacker_list[1]:
                        img[c, 4, 0] = pixel_value
                        img[c, 4, 1] = pixel_value
                        img[c, 5, 0] = pixel_value
                        img[c, 5, 1] = pixel_value
                    elif idx==args.attacker_list[2]:
                        img[c, 0, 4] = pixel_value
                        img[c, 0, 5] = pixel_value
                        img[c, 1, 4] = pixel_value
                        img[c, 1, 5] = pixel_value
                    else:
                        img[c, 4, 4] = pixel_value
                        img[c, 4, 5] = pixel_value
                        img[c, 5, 4] = pixel_value
                        img[c, 5, 5] = pixel_value
